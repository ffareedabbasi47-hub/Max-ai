        ...
        viewModelScope.launch {
            ...
            when (parsedAction.actionType) {
                ...
                ActionType.YOUTUBE_SEARCH -> {
                    ...
                    systemExecutionStatus = if (opened) "YouTube playing '$query'" else "Couldn't open YouTube"
                    spokenOverride = if (opened) "Playing '$query' on YouTube, Boss." else "I couldn't open YouTube, Boss."
                }
                ActionType.SYSTEM_DIAGNOSTIC -> {
